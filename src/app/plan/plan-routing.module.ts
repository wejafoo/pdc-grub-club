...
const planRoutes: Routes = [
	{ path: 'plan/:planId/update/event/:eventId/schedule',			component: EventScheduleComponent, canDeactivate: [CanDeactivateGuard], resolve: {plan: PlanDetailResolverService}},
