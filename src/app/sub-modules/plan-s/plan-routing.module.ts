...
const planRoutes: Routes = [{
	path: 'plan', canActivate: [AuthGuard], children: [
		{ path: 's', component: PlansComponent, children: [{ path: ':planId', component: PlanDetailComponent }]},
		{ path: ':planId', children: [
			{ path: 'version', children: [
				{ path: 's', component: VersionsComponent, canDeactivate: [CanDeactivateGuard], children: [
					{ path: ':versionId', component: VersionDetailComponent, canDeactivate: [CanDeactivateGuard]}
				]},
			{ path: ':versionId', component: ScheduleComponent, canDeactivate: [CanDeactivateGuard], resolve: {plan: PlanResolver},
				children: [{ path: 'event', children: [
					{ path: 's', component: EventListComponent, canDeactivate: [CanDeactivateGuard], resolve: {plan: PlanResolver},
						children: [{ path: ':eventId', component: EventDetailComponent}]},
